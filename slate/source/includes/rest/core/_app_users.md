...
The schema describes the fields you can expect to be associated with an appUser.
...
Client info is highly variable according to the platform a user is on. If a schema isn't specified below, the channel doesn't include any additional info about the appUser and client info will be represented as an empty JSON Object.

#### client info schema (Web)

| Field                   | Type   |
|-------------------------|--------|
| **sdkVersion** <span class="opt">optional</span>| String |
| **currentTitle** <span class="opt">optional</span>| String |
| **currentUrl** <span class="opt">optional</span>| String |
| **browserLanguage** <span class="opt">optional</span>| String |
| **referrer** <span class="opt">optional</span>| String |
| **userAgent** <span class="opt">optional</span>| String |
| **URL** <span class="opt">optional</span>| String |

#### client info schema (Android and iOS)

| Field                   | Type   |
|-------------------------|--------|
| **sdkVersion** <span class="opt">optional</span>|
| **wifi** <span class="opt">optional</span>| String |
| **os** <span class="opt">optional</span>| String |
| **appName** <span class="opt">optional</span>| String |
| **osVersion** <span class="opt">optional</span>| String |
| **installer** <span class="opt">optional</span>| String |
| **devicePlatform** <span class="opt">optional</span>| String |
| **buildNumber** <span class="opt">optional</span>| String |
| **carrier** <span class="opt">optional</span>| String |
| **appId** <span class="opt">optional</span>| String |
| **radioAccessTechnology** <span class="opt">optional</span>| String |

#### client info schema (Messenger)

| Field                   | Type   |
|-------------------------|--------|
| **avatarUrl** <span class="opt">optional</span>| String |

#### client info schema (WeChat)

| Field                   | Type   |
|-------------------------|--------|
| **openid** <span class="opt">optional</span>| String |
| **sex** <span class="opt">optional</span>| String |
| **language** <span class="opt">optional</span>| String |
| **city** <span class="opt">optional</span>| String |
| **province** <span class="opt">optional</span>| String |
| **country** <span class="opt">optional</span>| String |
| **headimgurl** <span class="opt">optional</span>| String |
| **subscribe_time** <span class="opt">optional</span>| Number |

#### client info schema (Twilio SMS)

| Field                   | Type   |
|-------------------------|--------|
| **phoneNumber** <span class="opt">optional</span>| String |
| **country** <span class="opt">optional</span>| String |
| **city** <span class="opt">optional</span>| String |
| **state** <span class="opt">optional</span>| String |
