...
| **avatarUrl** <span class="opt">optional</span>|  The URI of an appUser’s avatar, as provided by the channel.    | messenger, twitter |
| **locale** <span class="opt">optional</span>|  The AppUser localization, as set in the channel. Example: `"en_US"`.    | messenger |
| **timezone** <span class="opt">optional</span>|  A number representing the appUser’s timezone. Example: `-4`. | messenger |
| **gender** <span class="opt">optional</span>|  The gender set in the AppUser channel.| messenger |
| **isPaymentEnabled** <span class="opt">optional</span>|  A boolean that specifies if the appUser has enabled payments on Facebook Messenger.| messenger |
