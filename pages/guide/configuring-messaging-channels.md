...
In contrast with third-party channels like Facebook Messenger and Twilio SMS, the Web and Mobile SDKs only need to be passed a Smooch app's `_id` in order to be initialized. So no integration step is required.
